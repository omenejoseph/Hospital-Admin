...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg">Hospital Admin</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              @endif
                ...
                <p>
                  {{auth()->user()->name}}
                  <small>Staff since {{auth()->user()->created_at->diffForHumans()}}</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
      ...
      <div class="user-panel">
        <div class="pull-left image">
             @if(auth()->user()->photo())
              <img src="{{  URL::to('/') }}/images/{{ auth()->user()->photo['file_name']  }}" class="user-image" alt="User Image" />
             @else
              <img src="{{asset('images/default.png')}}" class="user-image image-circle" alt="User Image">
        ...
        <li class="treeview">
          ...
          @if(auth()->user()->hasRole('admin'))
            <li>
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('/admin/staff')}}"><i class="fa fa-circle-o"></i> View All Staff </a></li>
                <li><a href="{{url('/admin/staff/create')}}"><i class="fa fa-circle-o"></i> Add new Staff </a></li>
