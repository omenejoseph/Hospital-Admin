...
<head>
  ...
  <style>
  #banner{
	background: url("{{ asset('/newAssests/img/bg-banner.jpg') }}") no-repeat fixed;
        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img src="{{asset('newAssests/img/logo.png')}}" class="img-responsive" style="width: 140px; margin-top: -16px;"></a>
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="{{asset('newAssests/img/doctor1.jpg')}}" alt="..." class="team-img">
            <div class="caption">
              <h3>Jessica Wally</h3>
              <p>Doctor</p>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="{{asset('newAssests/img/doctor2.jpg')}}" alt="..." class="team-img">
            <div class="caption">
              <h3>Iai Donas</h3>
              <p>Doctor</p>
              <ul class="list-inline">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="{{asset('newAssests/img/doctor3.jpg')}}" alt="..." class="team-img">
            <div class="caption">
              <h3>Amanda Denyl</h3>
              <p>Doctor</p>
              <ul class="list-inline">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="{{asset('newAssests/img/doctor4.jpg')}}" alt="..." class="team-img">
            <div class="caption">
              <h3>Jason Davis</h3>
              <p>Doctor</p>
              <ul class="list-inline">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          ...
          <div class="testi-info">
            <!-- User Image -->
            <!-- <a href="#"><img src="{{asset('newAssests/img/thumb.png')}}" alt="" class="img-responsive"></a> -->
            <!-- User Name -->
